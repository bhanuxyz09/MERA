...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8035327921:AAEbFPPlYcBdtWQRcUjb_NCKN7-4HlRrZ7A'
OWNER_USERNAME = "BHANUXYZ2"
CO_OWNERS = []  # List of user IDs for co-owners
OWNER_CONTACT = "Contact to buy keys"
ALLOWED_GROUP_IDS = [-1002512896080]
MAX_THREADS = 1000
max_duration = 120
bot_open = False
...
START_IMAGES = [
    {
        ...
        'caption': (
            ...
            '⚠️ *🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🤬*⚠️' + '\n\n'
            '⚠️ *JOIN CHANNEL  https://t.me/yetoviphai *' + '\n\n'
        )
    },
